  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved selection as @selection" do
        ...
        post :create, {:selection => { "person" => "invalid value" }}, valid_session
        assigns(:selection).should be_a_new(Selection)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested selection" do
        ...
        Selection.any_instance.should_receive(:update_attributes).with({ "person" => "" })
        put :update, {:id => selection.to_param, :selection => { "person" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the selection as @selection" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Selection.any_instance.stub(:save).and_return(false)
        put :update, {:id => selection.to_param, :selection => { "person" => "invalid value" }}, valid_session
        assigns(:selection).should eq(selection)
      end
