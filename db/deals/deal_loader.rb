...
class Loader
  ...
  def parse_investor_type(string)
    ...
    values = {
      ...
      "Государственный фонд / организация" => 1,
      "Государственная корпорация" => 2,
      "Государственная корпорвция" => 2,
      "Государственная организация" => 2,
      "Корпорация" => 3,
      "Корпоративный венчурный фонд" => 4,
      "Частный венчурный фонд" => 5,
      "Частные венчурные фонды" => 5,
      "Частный фенчурный фонд" => 5,
      "Частный фвенчурный фонд" => 5,
      "Часстный венчурный фонд" => 5,
      "Фонд прямых инвестиций" => 6,
      "Фонд фондов" => 7,
      "Инвестиционный банк" => 8,
      "Инвестиционная компания" => 9,
      "Инвеcтиционная компания" => 9,
      "Прочие институциональные инвесторы" => 10,
      "Прочие институциональые инвесторы" => 10,
      "Прочие инстициональные инвесторы" => 10,
      "Прочие институциональные инвесторы/хедж-фонд" => 10,
      "Прочие институциональные инвесторы - хедж-фонд" => 10,
      "Бизнес-ангел" => 11,
      "Бизнес-ангелы" => 11,
      "Прочие фонды" => 12,
      "Прочие физлица (включая FFF)" => 13,
      "Прочие организации (юрлица)" => 14,
      "Прочие организации" => 14,
    }
